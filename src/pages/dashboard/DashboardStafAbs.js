...
export default function DashboardStafAbs() {
  const { auth } = useAuth();
  ...
  console.log('data_dashboard_stafAbs', dashboard);
  ...
  return (
    <Page title="Dashboard Staf Absensi dan Lembur">
      <Container maxWidth={themeStretch ? false : 'xl'}>
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} sm={6} md={3}>
            <AnalyticsWidgetSummary
              title="Absensi Belum Divalidasi"
