...
import { getAbsensi, setCurrentAbsensi, resetAbsensi, deleteAbsensi } from '../../redux/slices/absensi';
// routes
...
export default function AbsensiList() {
  ...
  const [orderBy, setOrderBy] = useState('waktu_masuk');
  ...
  return (
    <Page title="Absensi">
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <HeaderBreadcrumbs
          heading="Absensi"
          links={[{ name: 'Dashboard', href: PATH_DASHBOARD.root }, { name: 'Absensi' }]}
          action={
            <Button
              onClick={() => handleCreateAbsensi()}
              variant="contained"
              component={RouterLink}
              to={PATH_DASHBOARD.absensi.form}
                  ...
                  {filteredAbsensi?.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell>{waktuMasuk}</TableCell>
                        ...
                        <TableCell align="right">
                          <AbsensiMoreMenu
                            onDelete={() => handleOpenDeleteModal(idAbsensi)}
                            onUpdate={() => handleUpdateAbsensi(row)}
                          />
                        </TableCell>
                      </TableRow>
                    );
