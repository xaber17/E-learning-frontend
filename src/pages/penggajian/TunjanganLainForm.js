...
// sections
import InputTunjanganLainForm from '../../sections/@dashboard/penggajian/InputTunjanganLainForm'

// ----------------------------------------------------------------------

export default function TunjanganLainForm() {
  ...
  const title = 'Form Tunjangan/Pengurangan Lain';
  ...
  return (
    <Page title={title}>
      <Container maxWidth={themeStretch ? false : 'lg'}>
        ...
        <InputTunjanganLainForm currentData={currentPenggajianDetail} menu={title} action={action} />
      </Container>
    </Page>
  );
}
