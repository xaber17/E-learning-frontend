...
export default function LaporanAllPerBulanPdf({ currentData, waktu }) {
  ...
  const data = currentData?.bulanan;
        ...
        <View style={stylesPdf.section}>
          <View style={stylesPdf.table}>
            <View style={stylesPdf.tableRow}>
              ...
              <View style={stylesPdf.tableColSm}>
                <Text style={stylesPdf.th}>Jenis Pegawai</Text>
              </View>
              <View style={stylesPdf.tableColSm}>
            ...
            {data.map((row) => (
              <View style={stylesPdf.tableRow}>
                ...
                <View style={stylesPdf.tableColSm}>
                  <Text style={stylesPdf.tableCellLeft}>{row?.jenis_pegawai_bulan}</Text>
                </View>
                <View style={stylesPdf.tableColSm}>
                  <Text style={stylesPdf.tableCellCenter}>{row?.jumlah_absensi}</Text>
                </View>
                <View style={stylesPdf.tableColSm}>
                  <Text style={stylesPdf.tableCellCenter}>{row?.jam_lembur_harikerja}</Text>
                </View>
                <View style={stylesPdf.tableColSm}>
                  <Text style={stylesPdf.tableCellCenter}>{row?.jam_lembur_harilibur}</Text>
                </View>
                <View style={stylesPdf.tableColMd}>
                  <Text style={stylesPdf.tableCellRight}>{currency(row?.gaji_pokok_bulan)}</Text>
                </View>
                <View style={stylesPdf.tableColSm}>
                ...
                <View style={stylesPdf.tableColSm}>
                  <Text style={stylesPdf.tableCellRight}>{currency(row?.bonus_thr)}</Text>
                </View>
                <View style={stylesPdf.tableColSm}>
                  <Text style={stylesPdf.tableCellRight}>{currency(row?.nominal_tun_pajak_bonusthr)}</Text>
                </View>
                <View style={stylesPdf.tableColMd}>
                  <Text style={stylesPdf.tableCellRight}>{currency(row?.pph_21)}</Text>
                </View>
                <View style={stylesPdf.tableColSm}>
                  <Text style={stylesPdf.tableCellRight}>{currency(row?.total_potongan)}</Text>
                </View>
                <View style={stylesPdf.tableColMd}>
                  <Text style={stylesPdf.tableCellRight}>{currency(row?.gaji_bersih)}</Text>
                </View>
                <View style={stylesPdf.tableColSm}>
                  <Text style={stylesPdf.tableCellRight}>{currency(row?.pph_21_ditanggung)}</Text>
                </View>
                <View style={stylesPdf.tableColSm}>
                  <Text style={stylesPdf.tableCellRight}>{currency(row?.nominal_dit_bpjskes)}</Text>
                </View>
                <View style={stylesPdf.tableColSm}>
                  <Text style={stylesPdf.tableCellRight}>{currency(row?.nominal_dit_bpjsjp)}</Text>
                </View>
                <View style={stylesPdf.tableColSm}>
                  <Text style={stylesPdf.tableCellRight}>{currency(row?.nominal_dit_bpjsjht)}</Text>
                </View>
                <View style={stylesPdf.tableColMd}>
                  <Text style={stylesPdf.tableCellRight}>{currency(row?.budget_gaji)}</Text>
                </View>
              </View>
            ))}
            <View style={stylesPdf.tableRow}>
              <View style={stylesPdf.tableColXl}>
              ...
              <View style={stylesPdf.tableColSm}>
                <Text style={stylesPdf.tableCellRightSm}>{currency(currentData?.tunjangan_bpjs)}</Text>
              </View>
              <View style={stylesPdf.tableColSm}>
              ...
              <View style={stylesPdf.tableColMd}>
                <Text style={stylesPdf.tableCellRightSm}>{currency(currentData?.pph_21)}</Text>
              </View>
              <View style={stylesPdf.tableColSm}>
                <Text style={stylesPdf.tableCellRightSm}>{currency(currentData?.total_potongan)}</Text>
              </View>
              <View style={stylesPdf.tableColMd}>
                <Text style={stylesPdf.tableCellRightSm}>{currency(currentData?.gaji_bersih)}</Text>
              </View>
              <View style={stylesPdf.tableColSm}>
              ...
              <View style={stylesPdf.tableColMd}>
                <Text style={stylesPdf.tableCellRightSm}>{currency(currentData?.budget_gaji)}</Text>
              </View>
            </View>
          </View>
        </View>
