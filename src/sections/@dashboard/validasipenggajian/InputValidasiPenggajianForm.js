...
// List
import {
  FormValidasiPenggajianListHead,
  FormValidasiPenggajianListToolbar,
  FormValidasiPenggajianMoreMenu,
} from './list';

// ----------------------------------------------------------------------

InputValidasiPenggajianForm.propTypes = {
...
export default function InputValidasiPenggajianForm({ isEdit, currentUser }) {
  const navigate = useNavigate();

  const { enqueueSnackbar } = useSnackbar();

  const ValidasiPenggajianSchema = Yup.object().shape({
  ...
  const methods = useForm({
    resolver: yupResolver(ValidasiPenggajianSchema),
    defaultValues,
  });
